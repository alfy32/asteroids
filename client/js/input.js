...
ASTEROIDGAME.input = (function() {
  ...
  function Mouse() {
    ...
    $(document).bind('mousedown', mouseDown.bind(that));
    $(document).bind('mouseup', mouseUp.bind(that));
    $(document).bind('mousemove', mouseMove.bind(that));
    //window.addEventListener('mousedown', mouseDown.bind(that));
    //window.addEventListener('mouseup', mouseDown.bind(that));
    //window.addEventListener('mousemove', mouseDown.bind(that));
